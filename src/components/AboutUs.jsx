      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl max-w-xs border-l-4 border-[var(--color-tech-blue)]">
              <p className="text-gray-800 font-bold mb-2">Defense Grade Security</p>
              <p className="text-sm text-gray-500 text-justify">Registered & Trusted Vendor for Eastern Naval Command, Indian Navy - Visakhapatnam.</p>
            </div>
          </motion.div>
