...
const ServicesHub = () => {
  ...
  const softwareServices = [
    { name: 'Custom Software Dev', path: 'software-development', icon: <Code size={28} /> },
    { name: 'Cashless RFID Apps', path: 'software-development', icon: <CreditCard size={28} /> },
    { name: 'Biometric Attendance', path: 'software-development', icon: <Clock size={28} /> },
  ];
    ...
    <div className="bg-[var(--color-light-gray)] min-h-screen">
      ...
      <section className="bg-[var(--color-navy)] py-20 text-center">
        <div className="container mx-auto px-4">
           <h1 className="text-4xl md:text-5xl font-poppins font-bold text-white mb-6">Our Services</h1>
           <p className="text-xl text-gray-300 max-w-2xl mx-auto">
             Comprehensive solutions tailored for naval, defense, and enterprise organizations.
           </p>
        </div>
      </section>
