...
const ServiceDetail = () => {
  ...
  const serviceDataMap = {
    'security-systems': {
      ...
      features: ['CCTV Surveillance', 'Boom Barriers', 'Biometric Devices', 'RFID Readers & Tags', 'QR Code Scanners', 'Metal Detectors (Hand-held & Door Frame)', 'Explosive Detectors', 'Speed Check Systems'],
    ...
    'software-development': {
      ...
      features: ['Cashless Transaction Applications', 'Biometric Attendance Systems', 'Vehicle Tracking Applications', 'Inventory Management Systems', 'Face Recognition Systems'],
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Dynamic Header */}
      <section className="relative h-[40vh] bg-[var(--color-navy)] flex items-center justify-center overflow-hidden">
        <div 
